...
//		System.out.println(userLocB);
		...
		if (userLoc1C.equalsIgnoreCase("F")) {
			...
			//change state at x,y
			// displayMinefield or printMinefield method
			System.out.println(fl + " @ k,l");
		}
		
		if (box.equalsIgnoreCase("0") && !(userLoc1C.equalsIgnoreCase("F"))) { // need to print 0 or blank box or no box in place of box
			System.out.println("0 @");
		} 
		else if ((box.equalsIgnoreCase("1") || box.equalsIgnoreCase("2") || box.equalsIgnoreCase("3")
				|| box.equalsIgnoreCase("4") || box.equalsIgnoreCase("5") || box.equalsIgnoreCase("6")
				|| box.equalsIgnoreCase("7") || box.equalsIgnoreCase("8")) && !(userLoc1C.equalsIgnoreCase("F"))) { // these all get the same treatment of
																				// printing the
			// number in place of box
			System.out.println("# other than 0 and 9");
		} 
		else if (box.equalsIgnoreCase("9") && !(userLoc1C.equalsIgnoreCase("F"))) {
